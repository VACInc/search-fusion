...
function minimalPayload(overrides: Partial<FusionSearchPayload> = {}): FusionSearchPayload {
  return {
    ...
    providersFailed: [],
    providerDetails: [
      { provider: "brave", ok: true, tookMs: 200, rawCount: 2, attempts: 1, configured: true },
      { provider: "tavily", ok: true, tookMs: 500, rawCount: 1, attempts: 1, configured: true },
    ],
    providerRuns: [
      {
        provider: "brave",
    ...
    results: [
      {
        ...
        flags: [],
        rankings: [
          { providerId: "brave", rawRank: 1, score: 0.9, sourceType: "results", flags: [] },
          { providerId: "tavily", rawRank: 1, score: 0.85, sourceType: "results", flags: [] },
        ],
        variants: [],
      },
      {
        ...
        flags: [],
        rankings: [
          { providerId: "brave", rawRank: 2, score: 0.8, sourceType: "results", flags: [] },
        ],
        variants: [],
      },
    ],
